const Footer = () => {
  return (
    <footer className="border-t border-gray-300 py-8 bg-gray-100">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0 text-center md:text-left">
            <h2 className="text-xl font-bold text-gray-800">Job Hunt</h2>
            <p className="text-sm text-gray-600">&copy; 2025 Your Company. All rights reserved.</p>
          </div>
          
          <div className="flex space-x-6 mt-4 md:mt-0">
            <a href="https://facebook.com" className="hover:text-blue-600 text-gray-700 transition" aria-label="Facebook">
            ...
            <a href="https://twitter.com" className="hover:text-blue-400 text-gray-700 transition" aria-label="Twitter">
            ...
            <a href="https://linkedin.com" className="hover:text-blue-800 text-gray-700 transition" aria-label="LinkedIn">
